...
list_of_border_count = []
a = 0

for country in countries:

    if a <= (len(countries)-1):
        list_of_border_count.append(len(countries[a]['borders']))
        a += 1

    else:
        break

max_borders = max(list_of_border_count)

print("Number of borders:",
      max_borders,
      "\nCountry name:",
      countries[list_of_border_count.index(max_borders)]['name']['common'],
      "\nBorders list:",
      countries[list_of_border_count.index(max_borders)]['borders'])
